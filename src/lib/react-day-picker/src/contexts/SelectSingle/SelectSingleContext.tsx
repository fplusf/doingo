 ...
 */
export const SelectSingleContext = createContext<SelectSingleContextValue | undefined>(undefined);
...
export function SelectSingleProvider(props: SelectSingleProviderProps): JSX.Element {
  ...
  return (
    <SelectSingleProviderInternal initialProps={props.initialProps} children={props.children} />
  );
}
...
export function SelectSingleProviderInternal({
  ...
  return (
    <SelectSingleContext.Provider value={contextValue}>{children}</SelectSingleContext.Provider>
  );
}
